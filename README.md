...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-brainlife.app.569-blue.svg)](https://doi.org/10.25663/brainlife.app.569)

# Apply warp to Parcellation

This app will apply a non-linear warp to a parcellation/volume datatype using FSL.
...
You can submit this App online at [https://doi.org/10.25663/brainlife.app.569](https://doi.org/10.25663/brainlife.app.569) via the 'Execute' tab.
...
```json
{
    "input": "/input/parcellation/parc.nii.gz",
...
The main output of this App is a parcellation/volume datatype that has been warped.
